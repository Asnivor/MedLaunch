...
{
    public class Md_Legacy : VirtualDeviceBase
    {
        ...
        public static IDeviceDefinition TwoButton(int VirtualPort)
        {
            IDeviceDefinition device = new DeviceDefinitionLegacy();
        ...
        public static IDeviceDefinition SixButton(int VirtualPort)
        {
            IDeviceDefinition device = new DeviceDefinitionLegacy();
        ...
        public static IDeviceDefinition MegaMouse(int VirtualPort)
        {
            ...
            device.MapList = new List<Mapping>
            {
                ...
                new Mapping { Description = "Start Button", MednafenCommand = device.CommandStart +".megamouse.start" },
