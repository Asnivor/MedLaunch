    ...
    public class ConfigBaseSettings
    {
        ...
        public static ConfigBaseSettings GetConfigDefaults()
        {
            ConfigBaseSettings cfbs = new ConfigBaseSettings
            {
                ...
                ss__bios_sanity = true,
                ss__cart = "auto",
                ss__cart__kof95_path = "mpr-18811-mx.ic1",
                ss__cart__ultraman_path = "mpr-19367-mx.ic1",
                ss__cd_sanity = true,
                ss__input__mouse_sensitivity = 0.5,
                ss__input__port1 = "gamepad",
                ss__input__port2 = "gamepad",
                ss__input__port3 = "gamepad",
                ss__input__port4 = "gamepad",
                ss__input__port5 = "gamepad",
                ss__input__port6 = "gamepad",
                ss__input__port7 = "gamepad",
                ss__input__port8 = "gamepad",
                ss__input__port9 = "gamepad",
                ss__input__port10 = "gamepad",
                ss__input__port11 = "gamepad",
                ss__input__port12 = "gamepad",
                ss__midsync = false,
                ss__region_autodetect = true,
                ss__region_default = "jp",
                ss__scsp__resamp_quality = 4,
                ss__slend = 239,
                ss__slendp = 255,
                ss__slstart = 0,
                ss__slstartp = 0,
                ss__smpc__autortc = true,
                ss__smpc__autortc__lang = "english",

                psx__bios_eu = "scph5502.bin",
                psx__bios_jp = "scph5500.bin",
                psx__bios_na = "scph5501.bin",
                psx__bios_sanity = true,
                psx__cd_sanity = true,
                psx__dbg_level = 0,
                psx__h_overscan = true,
                psx__input__analog_mode_ct = false,
                ...
                psx__input__pport1__multitap = false,
                psx__input__pport2__multitap = false,
                psx__region_autodetect = true,
                psx__region_default = "jp",
                psx__slend = 239,
                psx__slendp = 287,
                psx__slstart = 0,
                psx__slstartp = 0,
                psx__spu__resamp_quality = 5,
